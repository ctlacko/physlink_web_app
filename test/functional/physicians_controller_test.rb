...
class PhysiciansControllerTest < ActionController::TestCase
  ...
  test "should create physician" do
    assert_difference('Physician.count') do
      post :create, :physician => { :firstname => @physician.firstname, :lastname => @physician.lastname, :login => @physician.login, :password => @physician.password, :specialty_id => @physician.specialty_id }
    end
  ...
  test "should update physician" do
    put :update, :id => @physician, :physician => { :firstname => @physician.firstname, :lastname => @physician.lastname, :login => @physician.login, :password => @physician.password, :specialty_id => @physician.specialty_id }
    assert_redirected_to physician_path(assigns(:physician))
  end
